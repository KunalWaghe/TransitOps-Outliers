...
from routers import auth, fuel_logs, expenses, dashboard, vehicles, drivers, trips, maintenance, reports, vehicle_documents, users, settings as app_settings_router
